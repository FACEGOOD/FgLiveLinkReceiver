...
{
	return LOCTEXT("SourceDisplayName", "FaceGood LiveLink Receiver");
}
...
void UJSONLiveLinkSourceFactory::testCreateSource(FIPv4Endpoint Endpoint)
{
	FOnLiveLinkSourceCreated InOnLiveLinkSourceCreated;
	InOnLiveLinkSourceCreated.ExecuteIfBound(MakeShared<FJSONLiveLinkSource>(Endpoint), Endpoint.ToString());
